...
imgOriginal = imread("2.jpg");
    ...
    mk1= imgOriginal.clone();
    
    for ( int i = 1; i < MAX_KERNEL_LENGTH; i = i + 2 )
    {
        bilateralFilter ( imgOriginal, mk1, i, i*3, i/2 );
        
    }


mk2= imgOriginal.clone();
    
    for ( int i = 1; i < MAX_KERNEL_LENGTH; i = i + 2 )
    {
        bilateralFilter ( imgOriginal, mk2, i, i*3, i/2 );
		...
		cvtColor(mk1, imgHSV1, COLOR_BGR2HSV); 		//Convert the captured frame from BGR to HSV
		cvtColor(mk2, imgHSV2, COLOR_BGR2HSV); 		//Convert the captured frame from BGR to HSV 
...
Rect Rec1(0, 0, 315, 470);		//0,0,315,470 for webcam/frontcam
Rect Rec2(300, 0, 950, 700);		//310,0,315,470 for webcam/frontcam
